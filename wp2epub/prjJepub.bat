...
if exist c:\j64\j64-803\bin\jconsole.exe set jexe=c:\j64\j64-803\bin\jconsole -js 
if exist c:\uap\j64-803\bin\jconsole.exe set jexe=c:\uap\j64-803\bin\jconsole -js
