...
\addcontentsline{toc}{subsection}{I lose another battle with Gravity}
...
%{[}caption id=``'' align=``alignleft'' width=``280'' caption=``24 Hour  Fitness''{]}
%\href{http://conceptcontrol.smugmug.com/Themes/Diaries/Cell-Phoning-It-In/17756793\_PfCsJz}{\includegraphics{chesterfield-gym-S.jpg}}
\captionsetup[floatingfigure]{labelformat=empty}
\begin{floatingfigure}[l]{0.30\textwidth}
\centering
{\includegraphics[width=0.28\textwidth]{chesterfield-gym-S.jpg}}
...
%\centering
%\includegraphics[width=0.23\textwidth]{chesterfield-gym-S.jpg}
%\caption{~~~IMCAPTION~~~}
%\label{fig:2045X0}
%\end{floatingfigure}
%\end{figure}
