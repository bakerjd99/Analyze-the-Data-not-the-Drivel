...
\subsection*{\href{https://bakerjd99.wordpress.com/2010/08/28/resume-blues-partly-alleviated-by-latex/}{Resume blues partly alleviated by \LaTeX}}
\addcontentsline{toc}{subsection}{Resume blues partly alleviated by \LaTeX}


\noindent\emph{Posted: 28 Aug 2010 16:26:06}
\vspace{6pt}
...
up to support resume creation. I am sure you have walked down the
\emph{power resume aisle} in your local big-box bookstore marveling at
how people can write entire books on composing three page resumes. Maybe
you have suffered through a corporate \emph{out-placing} where well
dressed \emph{human-resource} types will earnestly criticize your use of
bullets and personal pronouns. Whenever people go on about resumes I
always think of Monty Python's theory of Brontosauruses.

%{[}youtube=http://www.youtube.com/watch?v=cAYDiPizDIs{]}
\captionsetup[figure]{labelformat=empty}
\begin{figure}[htbp]
\centering
\href{https://www.youtube.com/watch?v=Xs7r5xfucPs}{\includegraphics[width=0.26\textwidth]{brontosauruspython.jpg}}
\caption{Click for Brontosaurus theory}
\end{figure}

Here's the nasty truth: a resume is an advertisement! Do you honestly
think anyone would dare to propose a \emph{theory of advertisements?} A
good ad gets noticed and helps sell the product. The same holds for
resumes.

I have a simple resume style that has worked well. The only complaints I
get relate to \emph{file types}. Some clients want plain text, some want
Word documents, others want PDFs and most don't care!

Lately I revised the \href{http://www.latex-project.org/}{\LaTeX} version
