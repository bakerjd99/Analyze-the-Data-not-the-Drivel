...
\href{https://xkcd.com/}{XKCD} pointed this out in this pithy cartoon.
...
\emph{boring light} shot of the Devil's Tower in Wyoming.
...
Luminar AI eliminates the drudgery, pushing a few buttons yields.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{pwp8screen.jpg}
\label{fig:7048X4}
\end{figure}
