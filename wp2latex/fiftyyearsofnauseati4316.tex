...
\addcontentsline{toc}{subsection}{Fifty Years of Nauseating Kennedy Nostalgia}
...
%\begin{enumerate}
%\item
%  Not a rhetorical question in hunting crazy rural
%  Utah.\hyperref[fnref1]{↩}
%\item
%  Little Johnny grew into another loathsome entitled Kennedy. He was a
%  dim witted echo of his dad and the
%  \href{https://www.youtube.com/watch?v=HAkrbNEOrOY}{original shiny
%  pony.} Perhaps we should encourage Justin Trudeau to take flying
%  lessons.\hyperref[fnref2]{↩}
%\item
%  Before the Internet it was a lot easier to keep the lid on political
%  dirt. Kennedy, like Obama today, was revered by a sycophantic
%  slobbering press.\hyperref[fnref3]{↩}
%\end{enumerate}
