...
\begin{SCfigure}[10]
\centering
\href{https://xkcd.com/1880/}{\includegraphics[width=0.38\textwidth]{eclipse_review.png}}
\caption[XKCD notes that total solar eclipse ``coolness'' is off the
scale.]{XKCD accurately notes that total solar eclipse ``coolness'' is off the
