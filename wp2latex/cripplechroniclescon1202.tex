...
\addcontentsline{toc}{subsection}{Cripple Chronicles Continue}
...
%\centering
%\href{http://bakerjd99.files.wordpress.com/2011/03/20110315-065116.jpg}{\includegraphics[width=0.23\textwidth]{20110315-065116.jpg}}
%\label{fig:1202X0}
%\end{floatingfigure}

\begin{floatingfigure}[r]{0.25\textwidth}
\centering
\href{http://bakerjd99.files.wordpress.com/2011/03/20110315-064742.jpg}{\includegraphics[width=0.23\textwidth]{20110315-064742.jpg}}
\caption{Invalid}
\label{fig:1202X1}
...
%\href{http://bakerjd99.files.wordpress.com/2011/03/20110315-064742.jpg}{\includegraphics{20110315-064742.jpg}}

%\captionsetup[floatingfigure]{labelformat=empty}
%\begin{figure}[htbp]
%\begin{floatingfigure}[l]{0.25\textwidth}
%\centering
%\includegraphics[width=0.23\textwidth]{20110315-065116.jpg}
%\caption{~~~IMCAPTION~~~}
%\label{fig:1202X0}
%\end{floatingfigure}
%\end{figure}
...
%\begin{floatingfigure}[l]{0.25\textwidth}
%\centering
%\includegraphics[width=0.23\textwidth]{20110315-064742.jpg}
%\caption{~~~IMCAPTION~~~}
%\label{fig:1202X1}
%\end{floatingfigure}
%\end{figure}
