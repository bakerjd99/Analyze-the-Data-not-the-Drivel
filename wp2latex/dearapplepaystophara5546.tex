...
\addcontentsline{toc}{subsection}{Dear Apple Pay Stop Harassing Me!}
...
%  \hypertarget{fn1}{}
%
%  Unless there are big changes at Apple this is my last iPhone. I want a
%  device that I absolutely control. ``If you don't control it you cannot
%  trust it.'' Any phone that I cannot even be sure is off does not
%  qualify. Burners may be my only option.\protect\hyperlink{fnref1}{↩}
%\end{enumerate}
