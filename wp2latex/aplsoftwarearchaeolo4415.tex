...
\caption[Siri's results use appropriate mathematical notations.
APL was way ahead of its time in this respect.]{Siri's results use appropriate mathematical notations. As we move away
from keyboards programming languages and mathematical notation will
merge. APL was way ahead of its time in this respect.}
\label{fig:4415X1}
\end{SCfigure}
